...
public class FtpClientPool extends BaseObjectPool<FTPClient>{
	...
	private HKMonitor log = HKMonitorFactory.getLogger(FtpClientPool.class.getName());
    ...
    public FtpClientPool(int poolSize, FtpClientFactory factory) throws Exception {
        ...
        ftpBlockingQueue = new ArrayBlockingQueue<FTPClient>(poolSize);
        initPool(poolSize);
    }
    ...
    public FTPClient borrowObject() throws Exception {
        ...
        if (null == client || !client.isRemoteVerificationEnabled()) {
